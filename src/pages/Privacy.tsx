            ...
            <main>
                <div style={{maxWidth: "600px", marginLeft: "auto", marginRight: "auto"}}>
                    ...
                    <div className="mb-12 mt-5 max-w-2xl font-serif">
                        <h2 className="pb-4 text-2xl">Personvern og sikkerhet på Jobbsøknad Demo</h2>
                        ...
                        <p className="mb-4 leading-normal">Søknadsteksten du fyller inn i Jobbsøknad Demoen lagres ikke, og sendes ikke til noen. Ikke legg inn personopplysninger som navn, telefon og e-post i denne demoen. Du kan legge til dette når du sender søknaden.</p>
